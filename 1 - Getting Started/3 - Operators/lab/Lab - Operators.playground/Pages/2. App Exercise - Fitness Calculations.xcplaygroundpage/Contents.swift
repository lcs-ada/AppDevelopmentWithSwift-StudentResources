 ...
 */
let heartRate1D: Double = 64
let heartRate2D: Double = 74
let heartRate3D: Double = 84
let addedHRD = 64 + 74 + 84
let averageHRD = addedHR / 3
//no, because the values I assigned to those three constants are integers.
...
let percentOfGoal: Double = 3467 / 10000
